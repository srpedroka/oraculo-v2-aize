...
- A Q4G-Q4T e a Q5A foram aprovadas no staging. A Q4T exige escolha explicita para vinculo trimestral por hipotese, normaliza `Margem operacional` para `operating_margin` e preserva a ressalva causal no banco e documentos. O smoke passou com Conducao 86,25, Plano Trimestral 97,50 e media 91,88. Custo Q4T US$ 0,048241; acumulado US$ 6,985203. O runner usa lock atomico por fase para impedir medicoes simultaneas. A Q5B r8 preserva 13 aprovacoes e repetira somente KPI R2 antes das duas rodadas finais. Producao permanece inalterada.
...
- Executar em ordem o plano integrado `plans/2026-07-16-qualidade-estrategica-operacional.md`: primeiro Mapa A de qualidade estratégica, depois Mapa B de qualidade operacional. A proxima fatia e a retomada incremental Q5B apos Q4T: `pnpm run eval:strategic:q5 -- resume-after-correction Q4T` preserva 23 aprovacoes totais e arquiva somente KPI R2 bloqueada; `pnpm run eval:strategic:q5 -- phase Q5B` repete essa rodada e depois somente as duas rodadas ausentes. Corrigir novos problemas e repetir apenas os cenarios afetados. Depois de Q5A-Q5D integralmente verdes, executar uma regressao geral limpa com todos os cenarios.
