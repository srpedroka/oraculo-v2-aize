...
- A Q4G-Q4AJ e a rodada incremental Q5A-Q5D foram aprovadas no staging. A regressao limpa r22 preserva 25 aprovacoes (Q5A 10, Q5B 15). Q4AI tornou o desafio trimestral proporcional; Q4AJ normaliza riscos estruturados antes de proposta/documento/WhatsApp e eliminou `[object Object]`. Smoke Q4AJ: Conducao 85, Plano Trimestral 92,50, Saida Derivada 100 e media 92,50. Acumulado US$ 13,638641. Validacao: 490 unitarios, catalogo 29/29, lint, build/bundle e secret scan em 527 arquivos. Somente `oracle-session` staging mudou; producao permanece inalterada.
