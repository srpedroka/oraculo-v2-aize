...
- O preflight O0 foi iniciado em 2026-07-18 e esta pausado. Infraestrutura declarada e backup externo estao verdes, mas o pacote Q4/Q5 ainda nao esta em producao, o CI mais recente da `main` esta vermelho, o snapshot incremental do evento de auditoria precisa concluir e o WhatsApp precisa confirmar inbound real. Nao iniciar O1 antes do gate descrito em `docs/OPERATIONAL_PILOT_O0.md`.
