...
- A Q4G-Q4P e a Q5A foram aprovadas no staging. A Q4P faz metas percentuais de produtividade sem medida definirem primeiro o indicador e apresentarem fontes candidatas sem escolher pelo gestor nem inventar baseline. O smoke passou com Conducao 100, Plano Trimestral 93,75, media 96,88 e 10/10 checks. Custo Q4P US$ 0,052941; acumulado US$ 6,344882. A Q5B r8 mantem oito aprovacoes e uma medicao de qualidade bloqueada; a retomada Q4P deve arquivar somente esse bloqueio e continuar incrementalmente. Producao permanece inalterada.
...
- Executar em ordem o plano integrado `plans/2026-07-16-qualidade-estrategica-operacional.md`: primeiro Mapa A de qualidade estratégica, depois Mapa B de qualidade operacional. A proxima fatia e a retomada incremental Q5B apos Q4P: `pnpm run eval:strategic:q5 -- resume-after-correction Q4P` preserva 18 aprovacoes totais e arquiva somente o bloqueio; `pnpm run eval:strategic:q5 -- phase Q5B` repete a combinacao ausente e continua com fail-fast. Corrigir novos problemas e repetir somente os cenarios afetados. Depois de Q5A-Q5D integralmente verdes, executar uma regressao geral limpa com todos os cenarios.
