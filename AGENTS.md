...
- A ponte R1B entre Revisao Semestral e Plano Estrategico Anual foi publicada em 2026-07-24 pela PR #30, merge `fc508d0`, release protegido `30102384560`, Netlify `6a637bb588a6e544269cbb75` e verificacao `30102788853`. Os documentos permanecem separados, mas `src/pages/Strategic.tsx` mostra a linhagem e inicia `strategic_review` com o `sourceDocumentId` da revisao preservada. `_shared/strategic-review-application.ts` valida empresa/ano/ciclo, injeta o documento como contexto nao confiavel e exige diff + `update_current_year`; `proposals.ts` repete o bloqueio dentro da confirmacao. Sem migration ou IA paga. R1B continua em 50% ate o reteste real. Fonte: `plans/ddr/R1B-ponte-revisao-plano-anual.md`.
