...
- A Q4G-Q4AC e a rodada incremental Q5A-Q5D foram aprovadas no staging. Na regressao limpa apos Q4AB, quatro medicoes Q5A passaram antes de o judge mostrar que `implantar um novo sistema` ainda recebia menu generico em vez de ser confrontado como meio. A Q4AC amplia atividades anuais para sistemas/ferramentas e exige uma pergunta sobre a mudanca empresarial. Smoke exato: Conducao 100, Plano Anual 100, media 100; custo US$ 0,057000 e acumulado US$ 10,209470. A grade parcial sera arquivada e todos os cenarios serao repetidos novamente do zero. Producao permanece inalterada.
