...
- A Q4G-Q4I e a Q5A foram aprovadas no staging. A Q5B `r4` foi interrompida automaticamente na quarta medicao: tres passaram; a quarta teve Conducao 86,25 e Plano Trimestral 90, mas falhou ao gravar porque a proposta vinculada omitiu `annualObjectives` e o aplicador nao reutilizou o `main_annual_objective_id` ja existente. Custo acumulado US$ 4,766588. Cleanup e preflight ficaram verdes. Proxima acao: correcao tecnica focada e smoke isolado do caso CRM; nao repetir Q5B nem tocar producao sem briefing/autorizacao.
