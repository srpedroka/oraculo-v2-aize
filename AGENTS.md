...
- A Q4G-Q4AB e a rodada incremental Q5A-Q5D foram aprovadas no staging. Na regressao limpa apos Q4AA, seis medicoes Q5A passaram antes de o judge detectar um ano historico vindo apenas do metadado do contexto. A Q4AB preserva anos ditos na conversa, converte o periodo nao confirmado para referencia relativa e nao altera os demais campos. O smoke do caso exato passou com Conducao 100, Plano Anual 100 e media 100; custo US$ 0,046061 e acumulado US$ 9,918158. O harness inicialmente exigia a frase literal `ciclo anterior`, foi corrigido para equivalentes seguros e revalidado sem nova API. A grade parcial sera arquivada e todos os cenarios serao repetidos novamente do zero. Producao permanece inalterada.
