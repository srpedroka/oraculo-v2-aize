...
- Ao aplicar uma revisão já aprovada, cada prioridade precisa ter um destino explícito no plano: manter, atualizar ou criar um objetivo. Use sourcePriorityKey para preservar a rastreabilidade.
- A primeira ação de cada prioridade precisa ter destino nos projetos estratégicos: manter, atualizar ou criar. Não deixe a ação apenas no texto da revisão.
- Projetos novos exigem nome, responsável, prazo e vínculo com o objetivo da mesma prioridade.
...
{"type":"apply_strategic_review","period":"2026","review_cycle":"midyear|year_end","motivo_revisao":"","semester_review":{"executiveSummary":"","confirmedAdvances":[],"gaps":[],"repeatedPatterns":[],"lessons":[],"risks":[],"evidenceGaps":[],"resultsByArea":[{"area":"","advances":[],"gaps":[],"evidence":[]}]},"second_semester_plan":{"focus":"","priorities":[{"sourcePriorityKey":"priority-1","title":"","rationale":"","linkedObjectiveId":"","expectedResult":"","metric":"","target":"","deadline":"","owner":"","firstAction":""}],"decisions":[],"renunciations":[],"risks":[],"cadence":[]},"annual_plan_update":{"mode":"preserve|update_current_year|prepare_next_year","planChanges":{"executiveSummary":"","themes":[],"rituals":[],"renunciations":[],"risks":[],"pendingDecisions":[],"historicalLessons":[]},"objectiveChanges":[{"operation":"keep|update","sourcePriorityKey":"priority-1","objectiveId":"","title":"","because":"","changes":{"title":"","result":"","metric":"","target":"","current":"","deadline":"AAAA-MM-DD","owner":"","evidence_plan":"","deliverables":[],"status":"on_track|at_risk|late|done"}},{"operation":"create","sourcePriorityKey":"priority-1","because":"","objective":{"title":"","type":"resultado|evolucao","result":"","metric":"","target":"","current":"","deadline":"AAAA-MM-DD","owner":"","source":"","deliverables":[]}},{"operation":"archive","objectiveId":"","title":"","because":""}],"projectChanges":[{"operation":"keep|update","sourcePriorityKey":"priority-1","projectId":"","because":"","changes":{"name":"","owner":"","deadline":"AAAA-MM-DD","status":"on_track|at_risk|late|done"}},{"operation":"create","sourcePriorityKey":"priority-1","because":"","project":{"name":"","owner":"","deadline":"AAAA-MM-DD","status":"on_track"}},{"operation":"archive","projectId":"","because":""}],"nextYearBrief":{"executiveSummary":"","themes":[],"priorities":[],"risks":[],"lessons":[]}},"adjustments":[],"unchanged":[]}`;
