...
- `_shared/session-adaptive.ts`: contrato e guardas puros da conducao adaptativa. Classifica a resposta como vaga, parcial ou pronta, valida fatos contra chaves concretas do estado da sessao, impede regressao/avanco vazio, repeticao semantica, perguntas multiplas, proposta prematura e exposicao de nomes tecnicos.
