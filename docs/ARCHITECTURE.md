...
- `_shared/plan-documents.ts`: transforma propostas confirmadas em `plan_documents` deterministico, incrementando versao por empresa/area/tipo/periodo. O trimestral preserva alinhamento/excecao anual; o mensal preserva alinhamento/excecao trimestral, capacidade, backlog, decisoes herdadas, riscos, bloqueios, cadencia e proximo compromisso.
