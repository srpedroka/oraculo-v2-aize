...
- `operational-health`: monitor protegido por segredo de cron ou autorização de owner. Consolida SLOs de frontend, banco, WhatsApp, backup, IA e restauração em snapshots service-only e mantém alertas deduplicados, sem conteúdo de negócio.
